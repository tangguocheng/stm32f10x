...
void gpio_input_process(void)
{
        ...
        if (PD12 != last_PD12) {
                last_PD12 = PD12;
                if ( PD12 == Bit_RESET ) {
                        RL_ON(1);RL_ON(2);RL_ON(7);RL_ON(10);RL_ON(11);
...
void key_0x13(u8 rx_data)
{
        ...
        if (rx_data & BIT1) {
                RL_OFF(2);RL_OFF(3);RL_OFF(4);RL_OFF(6);
        ...
        if (rx_data & BIT3) {
                if (cozy_state_word == 0){
                        cozy_state_word = 1;
                        RL_ON(10);RL_ON(15);RL_ON(17);
                        RL_OFF(2);RL_OFF(7);RL_OFF(9);
...
void key_0x14_delay_proc(void)
{
        ...
        if ((key_0x14_delay_flag == BIT2) && (key_0x14_delay_time == 8000)) {
                        RL_OFF(16);
        }  
        if ((key_0x14_delay_flag == BIT3) && (key_0x14_delay_time == 8000)) {
                        RL_OFF(14);
        }      
        if ((key_0x14_delay_flag == BIT4) && (key_0x14_delay_time == 8000)) {
                        RL_OFF(15);
        }              
