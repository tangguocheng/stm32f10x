...
void led_cnt(void)
{
        ...
        switch (num_cnt){
                case 0:SHOW_NUMBER(0);break;
                case 1:SHOW_NUMBER(1);break;
                case 2:SHOW_NUMBER(2);break;
                case 3:SHOW_NUMBER(3);break;
                case 4:SHOW_NUMBER(4);break;
                case 5:SHOW_NUMBER(5);break;
                case 6:SHOW_NUMBER(6);break;
                case 7:SHOW_NUMBER(7);break;
                case 8:SHOW_NUMBER(8);break;
                case 9:SHOW_NUMBER(9);break;
                default:SHOW_NUMBER(9); num_cnt = 9; break;
        }
        num_cnt--;
}
